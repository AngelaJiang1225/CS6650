...
public class ConnectionUtil {
    ...
    public static SessionFactory getSessionFactory(Class entityClass) throws IOException {
        if (sessionFactory == null) {
            HibernateConfig configParameters = loadHibernateConfigFile();
            try {
    ...
    private static HibernateConfig loadHibernateConfigFile() throws IOException {
        ...
        prop.load(input);
        return new HibernateConfig(prop);
    }
}